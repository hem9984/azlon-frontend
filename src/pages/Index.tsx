        ...
        >
          ...
          <ResizablePanel defaultSize={40}>
            <div className="h-full flex flex-col">
              <div className="bg-[#FFDEE2] rounded-lg p-4 mb-4">
              ...
              <div className="flex-grow bg-[#FFDEE2] rounded-lg p-4 flex flex-col">
                {mode === "ADVANCED MODE" ? (
                  <>
                    ...
                    <textarea
                      ...
                      className="w-full h-32 bg-transparent text-[#0D4B6B] resize-none focus:outline-none mb-4"
                    />
