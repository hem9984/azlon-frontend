...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-[#7E69AB] p-6 flex flex-col">
      <div className="max-w-7xl mx-auto w-full flex flex-col flex-grow">
        ...
        <div className={`w-full p-4 rounded-lg flex items-center mt-4 ${
          mode === "DEFAULT MODE" 
            ? 'bg-[#E5DEFF] border-2 border-[#1A1F2C]' 
            : 'bg-[#E5DEFF] border-2 border-[#1A1F2C]'
        }`}>
          <Switch 
            ...
            className={`
              border-2 border-[#1A1F2C] 
              ${mode === "ADVANCED MODE" 
                ? 'bg-[#7E69AB] data-[state=checked]:bg-[#7E69AB]' 
                : 'bg-[#E5DEFF] data-[state=unchecked]:bg-[#E5DEFF]'
              }
              [&>span]:bg-[#1A1F2C]
            `}
          />
          <span className="ml-2 font-medium text-[#1A1F2C]">{mode}</span>
        </div>
        ...
        >
          ...
          <ResizablePanel defaultSize={30}>
            <div className="bg-[#E5DEFF] rounded-lg p-4 flex flex-col h-full shadow-lg">
              <h2 className="text-[#1A1F2C] font-bold mb-4">INPUT</h2>
              <div className="space-y-2 flex-grow mb-4 overflow-y-auto">
                {files.map((file) => (
                  <div key={file} className="text-[#1A1F2C]">{file}</div>
                ))}
              </div>
              <Button 
                variant="secondary" 
                className="w-full bg-[#7E69AB] text-white hover:bg-[#6E59A5]"
          ...
          <ResizablePanel defaultSize={40}>
            <div className="space-y-4 h-full">
              ...
              <div className="bg-[#E5DEFF] rounded-lg p-4">
                <h2 className="text-[#1A1F2C] font-bold mb-4">PROMPT</h2>
                <textarea
                  value={prompt}
                  onChange={(e) => setPrompt(e.target.value)}
                  className="w-full h-32 bg-transparent text-[#1A1F2C] resize-none focus:outline-none"
                />
                <Button 
                  variant="secondary" 
                  className="w-full bg-[#7E69AB] text-white hover:bg-[#6E59A5]"
              ...
              {mode === "ADVANCED MODE" && (
                <div className="bg-[#E5DEFF] rounded-lg p-4">
                  <h2 className="text-[#1A1F2C] font-bold mb-4">TEST CONDITIONS</h2>
                  <textarea
          ...
          {/* Output Section */}
          <ResizablePanel defaultSize={30}>
            <div className="bg-[#E5DEFF] rounded-lg p-4 flex flex-col h-full">
              <h2 className="text-[#1A1F2C] font-bold mb-4">OUTPUT</h2>
              <div className="space-y-2 flex-grow mb-4 overflow-y-auto">
